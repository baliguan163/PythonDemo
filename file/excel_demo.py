...
if __name__ == "__main__":
    ...
    #插入数据库
    # 打开一个workbook
    workbook = xlrd.open_workbook('D:\天猫双十一官方正式爆款清单2017-11-10.xls')
    # 抓取所有sheet页的名称
