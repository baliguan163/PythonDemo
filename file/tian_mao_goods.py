...
if __name__ == "__main__":
    ...
    #插入数据库
    # 打开一个workbook
    # workbook = xlrd.open_workbook('E:\\c++\\tian_mao\\2018-01-23\\2018天猫年货节12018-01-23.xls')
    # workbook = xlrd.open_workbook('E:\\c++\\tian_mao\\2018-01-23\\2018天猫年货节22018-01-23.xls')
    # workbook = xlrd.open_workbook('E:\\c++\\tian_mao\\2018-01-23\\2018天猫年货节32018-01-23.xls')
    # workbook = xlrd.open_workbook('E:\\c++\\tian_mao\\2018-01-23\\2018天猫年货节42018-01-23.xls')
    workbook = xlrd.open_workbook('E:\\c++\\tian_mao\\2018-01-23\\2018天猫年货节52018-01-23.xls')
    # 抓取所有sheet页的名称
    ...
    for curr_row in range(num_rows):
        ...
        if curr_row !=0:
            ...
            print('------------------------------------------------------------------------------------------')
            print('sum_rows:%-5s row:%-5s  is:%s' % (num_rows,curr_row, row))
            sql = "insert into tian_mao_goods(goods_1_category,shop_name,platform_type,goods_id,goods_name,goods_url,goods_pic_url,goods_price,income_rate,sale_date,denomination,discount_coupon_price,discount_coupon_sum,discount_coupon_residue,discount_coupon_begin_date,discount_coupon_end_date,generalize_url,remark) values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
            # print('sql:',sql)
            # 插入数据
