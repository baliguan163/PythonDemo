...
if __name__ == '__main__':
    ...
    # sqlAll = "select * from goods_groupbuying;"
    # result = mysql.getAll(sqlAll)
    # print(str(len(result)))
    # print(result[0])
    # for i in range(0, len(result)):
    #     id = result[i]['id']
    #     goods_name = result[i]['goods_name'].decode('utf-8')
    #     print(str(i+1)+ " " + str(id) + " " + goods_name)
    ...
    # print(result)
    # id = result['id']
    # goods_name = result['goods_name'].decode('utf-8')
    # print('getOne:' + str(id) + " " + goods_name)



    sqlAll = "select * from goods_groupbuying where id=1"
    result = mysql.update(sqlAll)
    # print('result len:' + str(len(result)))
    print(result)
